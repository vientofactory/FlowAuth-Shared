...
export const TWO_FACTOR_CONSTANTS = {
  ...
  BACKUP_CODE_LENGTH: 16, // 각 백업 코드 길이 (Base32)
  BACKUP_CODE_ENTROPY_BYTES: 10, // 백업 코드 엔트로피 (80비트)
  BACKUP_CODE_MIN_UNIQUE_CHARS: 8, // 최소 고유 문자 수
  BACKUP_CODE_MAX_GENERATION_ATTEMPTS: 50, // 최대 생성 시도 횟수 증가
  WINDOW_TIME: 30, // TOTP 윈도우 시간 (초)
  BACKUP_CODE_FORMAT_LENGTH: 19, // 하이픈 포함한 형식화된 길이 (XXXX-XXXX-XXXX-XXXX)
} as const;
